...
import { map, startWith, delay, catchError, tap, retry  } from 'rxjs/operators';
...
export class ProductService {
  ...
  public Currency = { name: 'Kroner', currency: 'DKK ', price: 1 } // Default Currency
...
//withCredentials: false // midlertidig ændring
  ...
  */
       ...
       */
/* MongoDB Version - Ikke færdig endnu 
      private get products(): Observable<Product[]> {
        this.Products = this.http.get<Product[]>(this.nodemongoUrl, this.httpOptions).pipe(map(data => data));
...
public getProductBySlug2(slug: string): Observable<Product> {
 ...
 //  .get<Product>('https://us-central1-fries-bureau-test.cloudfunctions.net/server/products/22565423394', this.httpOptions)
      .pipe(
        retry(0),
        catchError(this.handleError)
      )
...
*/
  ...
  */
  ...
  public addToWishlist(product): any {
    ...
    this.toastrService.success('Produktet er tilføjet ønskelisten.');
  ...
  */
  ...
  public addToCompare(product): any {
    ...
    this.toastrService.success('Produktet er tilføjet til sammenligning.');
  ...
  */
  ...
  public addToCart(product): any {
    ...
    // Leder om der findes produkt id i state.cart
    if (cartItem) {
  ...
  public calculateStockCounts(product, quantity) {
    ...
    if (stock < qty || stock == 0) {
      this.toastrService.error('Du kan ikke tilføje flere produkter.  På lager er der '+ stock +' produkter.');
      return false
    }
    return true
  }
...
//    console.log('State of the Cart ',state.cart);
    state.cart.length = 0;
//    state.cart = [];
